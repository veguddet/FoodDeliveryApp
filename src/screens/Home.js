...
import { View, Text, ScrollView, Image, StatusBar, TouchableOpacity, TextInput, FlatList } from 'react-native';
import {Categories, COLOURS} from '../constants/data';
    ...
    <View
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            style={{
                ...
                <StatusBar backgroundColor={COLOURS.white} barStyle="dark-content" translucent={false}/>
          <Image
          ...
          />
           <View
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../assets/images/venky.jpeg')}
                style={{
                  width: 40,
                  height: 40,
                  borderRadius: 20,
